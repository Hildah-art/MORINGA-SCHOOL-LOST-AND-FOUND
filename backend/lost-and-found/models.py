...
class User(db.Model):
    ...
    lost_items = db.relationship("Item", backref="owner", foreign_keys='Item.user_id')
    ...
    rewards = db.relationship("Reward", backref="reward_user", foreign_keys='Reward.user_id')
    notifications = db.relationship("Notification", backref="user")
    comments = db.relationship("Comment", backref="user")


# ---------------------
# Item Model (lost or found)
# ---------------------
class Item(db.Model):
    __tablename__ = 'items'
    ...
    claim = db.relationship("Claim", backref="item", uselist=False)
    reward_info = db.relationship("Reward", backref="item", uselist=False)
