...
# ---------------------
# Reward Model (✅ fixed line added here)
# ---------------------
class Reward(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    item_id = db.Column(db.Integer, db.ForeignKey('found_items.id'), nullable=False)  # ✅ ForeignKey added
    user_id = db.Column(db.Integer, db.ForeignKey('users.id'), nullable=False)  # ✅ assumed based on relationship in User
